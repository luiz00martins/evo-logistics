...
peripheral.test_module = function()
	...
	local function test_initial_state()
		assert_equals(vanilla_barrel.list[1].name, 'minecraft:coal')
		assert_equals(vanilla_barrel.list[1].count, 64)
		assert_equals(vanilla_chest.list[1], nil)
		assert_equals(bronze_barrel.items[1], nil)
		assert_equals(steel_barrel.items[1], nil)
	end
	...
	test_initial_state()
	assert_equals(peripheral.call('minecraft:barrel_0', 'pushItems', 'minecraft:chest_0', 1, nil, 1), 64)
	assert_equals(vanilla_barrel.list[1], nil)
	assert_equals(vanilla_chest.list[1].name, 'minecraft:coal')
	assert_equals(vanilla_chest.list[1].count, 64)
	...
	assert_equals(peripheral.call('minecraft:barrel_0', 'pushItems', 'minecraft:barrel_0', 1, 20, 10), 20)
	assert_equals(vanilla_barrel.list[1].name, 'minecraft:coal')
	assert_equals(vanilla_barrel.list[1].count, 44)
	assert_equals(vanilla_barrel.list[10].name, 'minecraft:coal')
	assert_equals(vanilla_barrel.list[10].count, 20)

	test_utils.set_title('Testing moving to a partially filled inventory')
	-- Also testing moving an item with a custom 'maxCount'.
	assert_equals(vanilla_barrel.list[4].name, 'minecraft:ender_pearl')
	assert_equals(vanilla_barrel.list[5].name, 'minecraft:ender_pearl')
	assert_equals(vanilla_barrel.list[4].count, 16)
	assert_equals(vanilla_barrel.list[5].count, 10)
	assert_equals(peripheral.call('minecraft:barrel_0', 'pushItems', 'minecraft:barrel_0', 4, nil, 5), 6)
	assert_equals(vanilla_barrel.list[4].count, 10)
	assert_equals(vanilla_barrel.list[5].count, 16)

	test_utils.set_title('Testing moving to a slot with a different item')
	assert_equals(vanilla_barrel.list[1].name, 'minecraft:coal')
	assert_equals(vanilla_barrel.list[4].name, 'minecraft:ender_pearl')
	assert_equals(peripheral.call('minecraft:barrel_0', 'pushItems', 'minecraft:barrel_0', 1, nil, 4), 0)
	assert_equals(vanilla_barrel.list[1].name, 'minecraft:coal')
	assert_equals(vanilla_barrel.list[4].name, 'minecraft:ender_pearl')
	...
	assert_equals(peripheral.call('minecraft:barrel_0', 'pushItems', 'minecraft:barrel_0', 1, nil, 60), 0)
	...
	assert_equals(techreborn_storage_unit.list[2].count, 40)
	peripheral.custom.produce_item('techreborn:storage_unit_0', 1, 'minecraft:iron_ingot', 40)
	peripheral.custom.tick_inventory('techreborn:storage_unit_0')
	...
	assert_equals(techreborn_storage_unit.list[2].count, 64)
	peripheral.custom.consume_item('techreborn:storage_unit_0', 2, 20)
	peripheral.custom.tick_inventory('techreborn:storage_unit_0')
	assert_equals(techreborn_storage_unit.data.item, nil)
	assert_equals(techreborn_storage_unit.list[2].count, 60)
	peripheral.custom.consume_item('techreborn:storage_unit_0', 2, 60)
	assert_equals(techreborn_storage_unit.list[2], nil)
	...
	assert_equals(techreborn_storage_unit.list[1].count, 8)
	assert_equals(techreborn_storage_unit.list[2].count, 64)
	...
	assert_equals(auto_crafting_table.list[10].name, 'minecraft:oak_planks')
	assert_equals(auto_crafting_table.list[10].count, 4)
	...
	peripheral.custom.tick_inventory('techreborn:auto_crafting_table_0')
	assert_equals(auto_crafting_table.list[10].name, 'minecraft:oak_planks')
	assert_equals(auto_crafting_table.list[10].count, 64)
	assert_equals(auto_crafting_table.list[1].count, 16)
	peripheral.custom.consume_item('techreborn:auto_crafting_table_0', 10, 64)
	peripheral.custom.tick_inventory('techreborn:auto_crafting_table_0')
	assert_equals(auto_crafting_table.list[10].count, 64)
	assert_equals(auto_crafting_table.list[1], nil)
	...
	assert_equals(assembly_machine.list[3].name, 'techreborn:advanced_circuit')
	assert_equals(assembly_machine.list[3].count, 3)
	assert_equals(assembly_machine.list[2].name, 'techreborn:electrum_plate')
	assert_equals(assembly_machine.list[2].count, 1)

	test_utils.set_title('Testing producing items to MI barrel')
	reset()
	peripheral.custom.produce_item('modern_industrialization:bronze_barrel_0', nil, 'minecraft:oak_planks', 10)
	assert_equals(bronze_barrel.items['minecraft:oak_planks'].name, 'minecraft:oak_planks')
	assert_equals(bronze_barrel.items['minecraft:oak_planks'].count, 10)
	for i=1,19 do
		peripheral.custom.produce_item('modern_industrialization:bronze_barrel_0', nil, 'minecraft:oak_planks', 10)
	end
	assert_equals(bronze_barrel.items['minecraft:oak_planks'].count, 200)
	peripheral.custom.produce_item('modern_industrialization:bronze_barrel_0', nil, 'minecraft:oak_planks', 300)
	assert_equals(bronze_barrel.items['minecraft:oak_planks'].count, 500)
	...
	test_utils.set_title('Testing moving item from/to MI barrel')
	...
	assert_equals(peripheral.call('modern_industrialization:bronze_barrel_0', 'pushItem', 'minecraft:chest_0'), 128)
	assert_equals(peripheral.call('minecraft:chest_0', 'getItemDetail', 1).name, 'minecraft:oak_planks')
	assert_equals(peripheral.call('minecraft:chest_0', 'getItemDetail', 1).count, 64)
	assert_equals(peripheral.call('minecraft:chest_0', 'getItemDetail', 2).count, 64)

	test_utils.set_title('Testing moving a specific amount of items...') -- from/to MI barrel')
	reset()
	peripheral.custom.produce_item('modern_industrialization:bronze_barrel_0', nil, 'minecraft:oak_planks', 1000)
	assert_equals(peripheral.call('modern_industrialization:bronze_barrel_0', 'pushItem', 'minecraft:chest_0', nil, 30), 30)
	assert_equals(peripheral.call('minecraft:chest_0', 'getItemDetail', 1).count, 30)
	assert_equals(peripheral.call('modern_industrialization:bronze_barrel_0', 'pushItem', 'minecraft:chest_0', nil, 30), 30)
	assert_equals(peripheral.call('minecraft:chest_0', 'getItemDetail', 1).count, 60)
	assert_equals(peripheral.call('modern_industrialization:bronze_barrel_0', 'pushItem', 'minecraft:chest_0', nil, 30), 30)
	assert_equals(peripheral.call('minecraft:chest_0', 'getItemDetail', 1).count, 64)
	assert_equals(peripheral.call('minecraft:chest_0', 'getItemDetail', 2).count, 26)

	assert_equals(peripheral.call('modern_industrialization:bronze_barrel_0', 'pullItem', 'minecraft:chest_0', nil, 30), 30)
	assert_equals(peripheral.call('minecraft:chest_0', 'getItemDetail', 1).count, 34)

	test_utils.set_title('Testing moving items to barrel until full')
	reset()
	...
	assert_equals(peripheral.call('modern_industrialization:bronze_barrel_0', 'pushItem', 'modern_industrialization:steel_barrel_0'), 0)
	assert_equals(peripheral.call('modern_industrialization:bronze_barrel_0', 'items')[1].count, 2048)
	assert_equals(peripheral.call('modern_industrialization:steel_barrel_0', 'items')[1].count, 5952)
